...
<?php
	$reserve = mysqli_query($con, "SELECT booktable.Booktitle, booktable.Author, reservations.ISBN, reservations.ReserveDate FROM booktable INNER JOIN reservations ON booktable.ISBN = reservations.ISBN WHERE reservations.Username =  '$username'");
                   ...
                   echo '<td align="center"><table class="BookTable">';
                             echo ' <thead>';
                                 echo ' <tr>';
										...
										echo '<th width="4%">ISBN</th>';									
                                        echo '<th width="4%">ReserveDate</th>';
                                 echo '</tr>';
							echo '</thead>';
							echo '<tbody>';
