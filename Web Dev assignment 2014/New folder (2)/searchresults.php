...
<?php
	...
	$result = mysqli_query($con, "SELECT booktable.*, categories.CategoryDescription FROM books INNER JOIN categories ON booktable.CategoryID=categories.CategoryID WHERE  $ColumnSearch LIKE '%$search%' ");				
